...
class WomanShoes2 extends StatefulWidget {
  const WomanShoes2({Key? key}) : super(key: key);

  @override
  State<WomanShoes2> createState() => _WomanShoes2State();
}

class _WomanShoes2State extends State<WomanShoes2> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/shoes woman/Screenshot_2024-08-10_142023-removebg-preview.png',
    'Images/shoes woman/Screenshot_2024-08-10_141957-removebg-preview.png',
  ];

  final String shoeName = 'Classic women brown';
  final String shoeDescription = 'Shoes Woman';
  final double shoePrice = 650.0;
