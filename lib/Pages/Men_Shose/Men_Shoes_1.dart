...
class MenShoes1 extends StatefulWidget {
  const MenShoes1({Key? key}) : super(key: key);

  @override
  State<MenShoes1> createState() => _MenShoes1State();
}

class _MenShoes1State extends State<MenShoes1> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/shoes men/Screenshot 2024-05-06 020831.png',
    'Images/shoes men/Screenshot 2024-05-06 020852.png',
  ];

  final String shoeName = 'Sport Running Shoes';
  final String shoeDescription = 'Shoes Men';
