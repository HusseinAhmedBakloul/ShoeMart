...
class MenShoes2 extends StatefulWidget {
  const MenShoes2({Key? key}) : super(key: key);

  @override
  State<MenShoes2> createState() => _MenShoes2State();
}

class _MenShoes2State extends State<MenShoes2> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/shoes men/Screenshot 2024-04-09 001313.png',
    'Images/shoes men/Screenshot 2024-04-14 214651.png',
  ];

  final String shoeName = 'Sport Running Shoes';
  final String shoeDescription = 'Shoes Men';
  final double shoePrice = 560.0;
