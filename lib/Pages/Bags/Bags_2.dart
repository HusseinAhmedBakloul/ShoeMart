...
class Bags2 extends StatefulWidget {
  const Bags2({Key? key}) : super(key: key);

  @override
  State<Bags2> createState() => _Bags2State();
}

class _Bags2State extends State<Bags2> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/Accessories/Screenshot_2024-08-10_152904-removebg-preview.png',
    'Images/Accessories/Screenshot_2024-08-10_152926-removebg-preview.png',
  ];

  final String shoeName = 'blue handbag';
  final String shoeDescription = 'Bags';
  final double shoePrice = 500.0;
