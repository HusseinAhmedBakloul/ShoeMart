...
class Bags1 extends StatefulWidget {
  const Bags1({Key? key}) : super(key: key);

  @override
  State<Bags1> createState() => _Bags1State();
}

class _Bags1State extends State<Bags1> {
  int _currentPageIndex = 0;
  int? _selectedSize; 

  final List<String> images = [
    'Images/Accessories/Screenshot_2024-08-10_150840-removebg-preview.png',
    'Images/Accessories/Screenshot_2024-08-10_150909-removebg-preview.png',
  ];

  final String shoeName = 'Beautiful elegance';
  final String shoeDescription = 'Bags';
  final double shoePrice = 600.0;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [12, 14, 15, 16, 17].map((size) {
                      return Padding(
