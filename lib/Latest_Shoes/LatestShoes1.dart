...
class Latestshoes1 extends StatefulWidget {
  const Latestshoes1({Key? key}) : super(key: key);

  @override
  State<Latestshoes1> createState() => _Latestshoes1State();
}

class _Latestshoes1State extends State<Latestshoes1> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/shoes men/Screenshot 2024-08-10 203224.png',
    'Images/shoes men/Screenshot 2024-08-10 203235.png',
  ];
