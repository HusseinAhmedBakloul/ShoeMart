...
class LatestShoes3 extends StatefulWidget {
  const LatestShoes3({Key? key}) : super(key: key);

  @override
  State<LatestShoes3> createState() => _LatestShoes3State();
}

class _LatestShoes3State extends State<LatestShoes3> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/shoes woman/Screenshot_2024-08-10_205100-removebg-preview.png',
    'Images/shoes woman/Screenshot_2024-08-10_205047-removebg-preview.png',
  ];

  final String shoeName = 'Woman Shoes';
