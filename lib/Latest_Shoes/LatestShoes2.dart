...
class Latestshoes2 extends StatefulWidget {
  const Latestshoes2({Key? key}) : super(key: key);

  @override
  State<Latestshoes2> createState() => _Latestshoes2State();
}

class _Latestshoes2State extends State<Latestshoes2> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/shoes men/Screenshot 2024-08-10 204523.png',
    'Images/shoes men/Screenshot 2024-08-10 204541.png',
  ];

  final String shoeName = 'New pair of white sneakers';
  final String shoeDescription = 'Shoes Men';
  final double shoePrice = 400.0;
