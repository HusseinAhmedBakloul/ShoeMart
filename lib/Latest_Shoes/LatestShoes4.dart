...
class LatestShoes4 extends StatefulWidget {
  const LatestShoes4({Key? key}) : super(key: key);

  @override
  State<LatestShoes4> createState() => _LatestShoes4State();
}

class _LatestShoes4State extends State<LatestShoes4> {
  int _currentPageIndex = 0;
  int? _selectedSize;

  final List<String> images = [
    'Images/Accessories/Screenshot_2024-08-10_211348-removebg-preview.png',
    'Images/Accessories/Screenshot_2024-08-10_211324-removebg-preview.png',
    
  ];

  final String shoeName = 'Pink handbags';
